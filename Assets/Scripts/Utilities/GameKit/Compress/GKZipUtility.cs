...
{
    public static class GKZipUtility
    {
        #region ZipCallback
        ...
        /// <returns></returns>
        public static bool Zip(string[] _fileOrDirectoryArray, string _outputPathName, int compressLevel = 6, string _password = null, ZipCallback _zipCallback = null)
        {
            ...
            zipOutputStream.SetLevel(compressLevel);    // 压缩质量和压缩速度的平衡点
        ...
        /// <returns></returns>
        public static bool UnzipFile(string _filePathName, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null, bool ignoreEntryName = false)
        {
            ...
            try
            {
                return UnzipFile(File.OpenRead(_filePathName), _outputPath, _password, _unzipCallback, ignoreEntryName);
            }
        ...
        /// <param name="_unzipCallback">UnzipCallback对象，负责回调</param>
        /// <returns></returns>
        public static bool UnzipFile(byte[] _fileBytes, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null, bool ignoreEntryName = false)
        {
        ...
        /// <param name="_unzipCallback">UnzipCallback对象，负责回调</param>
        /// <returns></returns>
        public static bool UnzipFile(Stream _inputStream, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null, bool ignoreEntryName = false)
        {
            ...
            using (ZipInputStream zipInputStream = new ZipInputStream(_inputStream))
            {
                ...
                while (null != (entry = zipInputStream.GetNextEntry()))
                {
                    ...
                    string filePathName = ignoreEntryName ? _outputPath + Path.GetFileName(entry.Name) : _outputPath + entry.Name; //Path.Combine(_outputPath, entry.Name);

                    //				Debug.Log (string.Format("UnzipFile filePathName:  {0}", filePathName));
