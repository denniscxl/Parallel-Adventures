...
public class GKVillage : GKNpc {
    
    #region PublicField
    #endregion

    #region PrivateField
    private UIVillageHUD _hud;
    ...
    private UIVillageHUD SpawnHUD()
    {
        var hud = UIController.LoadPanel<UIVillageHUD>(); ;
    ...
    {
        string path = string.Format("Prefabs/Partile/FX_Ring_{0}", type.ToString());
